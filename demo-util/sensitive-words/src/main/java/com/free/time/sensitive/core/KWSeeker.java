...
import com.free.time.sensitive.model.SensitiveWordResult;
import com.free.time.sensitive.processor.*;
import com.free.time.sensitive.util.AnalysisUtil;
import com.free.time.sensitive.util.EmojiUtil;
...
public class KWSeeker {
    ...
    public String highlightWords(String text, AbstractFragment fragment) {
        return (String) process(new AdaptiveProcessor(), text, fragment);
    }
    ...
    public String htmlHighlightWords(String text) {
        return (String) process(new AdaptiveProcessor(), text, new HTMLFragment("<font color='red'>",
                "</font>"));
    }
    ...
    public String replaceWords(String text) {
        return (String) process(new AdaptiveProcessor(), text, new IgnoreFragment("***"));
    }
